...
static const char *const yytname[] =
{
  ...
  "'('", "')'", "$accept", "expr_p", "expr", "term", "fact", 0
};
#endif
  ...
  switch (yyn)
    {
        case 2:
#line 19 "yacc.y"
    { if(count==1){printf("Assign %s to t%d\n",(yyvsp[(1) - (1)].sval),count);printf("Print t%d\n",count);}else printf ( "Print %s\n",(yyvsp[(1) - (1)].sval) ); }
    break;

  case 3:
#line 22 "yacc.y"
    { printf  ( "Assign %s Plu %s to t%d\n" , (yyvsp[(1) - (3)].sval) , (yyvsp[(3) - (3)].sval) , count );char buffer[6]; sprintf(buffer,"t%d",count);count++; (yyval.sval) = buffer ;}
    break;
